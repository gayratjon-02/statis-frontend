...
export default function LandingPage() {
    ...
    const plans = [
        {
            ...
            features: ["1 brand", "3 products", "All ad concepts", "Multi-ratio export (1:1, 9:16, 16:9)", "Edit Design feature", "250 credits/month"],
        ...
        },
        {
            ...
            features: ["5 brands", "10 products per brand", "All ad concepts", "Multi-ratio export (1:1, 9:16, 16:9)", "Edit Design feature", "750 credits/month", "Priority generation queue"],
        ...
        },
        {
            ...
            features: ["Unlimited brands", "Unlimited products", "All ad concepts", "Multi-ratio export (1:1, 9:16, 16:9)", "Edit Design feature", "2,000 credits/month", "Priority generation queue", "Up to 5 team members"],
            cta: "Get Started", popular: false,
        },
    ];
    ...
    const features = [
        ...
        { title: "Edit Design", desc: `Want changes? Describe what to edit and the AI regenerates it. ${cc.credits_per_fix_errors} credits instead of ${cc.credits_per_generation}.`, letter: "Ed" },
    ...
    const faqs = [
        ...
        { q: "What if the AI output doesn't look good?", a: `You get 6 variations per generation, so there's usually at least one strong option. If not, use Edit Design (${cc.credits_per_fix_errors} credits) to describe what you'd like changed and the AI will regenerate with your edits. You can also regenerate individual slots for ${cc.credits_per_regenerate_single} credits.` },
