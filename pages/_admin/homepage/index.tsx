                ...
                {activeNav === "invites" && session?.admin?.role === AdminRole.SUPER_ADMIN && (
                    <div className="admin-dash__section">
                        ...
                        <div style={{ padding: "22px" }}>
                            {generatedInvite && (
                                <div style={{ padding: "16px", background: "rgba(16, 185, 129, 0.1)", border: "1px solid rgba(16, 185, 129, 0.2)", borderRadius: "8px", marginBottom: "20px" }}>
                                    <div style={{ color: "#10B981", fontSize: "14px", fontWeight: "600", marginBottom: "8px" }}>New Token Generated Successfully</div>
                                    <div style={{ display: "flex", gap: "12px", alignItems: "center" }}>
                                        <code style={{ background: "rgba(0,0,0,0.3)", padding: "10px 14px", borderRadius: "6px", fontFamily: "monospace", fontSize: "15px", color: "white", flex: 1 }}>{generatedInvite}</code>
                                        <button
                                            className="admin-dash__btn admin-dash__btn--ghost"
                                    ...
                                    <div style={{ color: "var(--muted)", fontSize: "12px", marginTop: "10px" }}>Save this token now. It grants registration access.</div>
                                </div>
                            )}
