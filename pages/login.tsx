...
export default function UserAuth() {
    ...
    const [tosAttempted, setTosAttempted] = useState(false);
    ...
    const planInfo: Record<string, { label: string; monthlyPrice: number; yearlyMonthly: number; yearlyTotal: number; credits: string; badge?: string }> = {
        ...
        growth: { label: "Growth Engine", monthlyPrice: 199, yearlyMonthly: 166, yearlyTotal: 1990, credits: "2,000 credits" },
    };
                    ...
                    <div className="admin-auth__form-wrapper">
                        ...
                        {mode === "login" ? (
                            ...
                            <form onSubmit={handleSignup} className="admin-auth__form">
                                ...
                                <div style={{ marginTop: 8, marginBottom: 8 }}>
                                    <div style={{ display: "flex", alignItems: "flex-start", gap: 10 }}>
                                        <input
                                            ...
                                            onChange={(e) => {
                                                ...
                                                if (e.target.checked) setTosAttempted(false);
                                            }}
                                            style={{
                                                marginTop: 3,
                                                width: 16,
                                        ...
                                        />
                                        <label htmlFor="tos_accept" style={{ fontSize: 13, color: "var(--text)", lineHeight: 1.4, cursor: "pointer" }}>
                                    ...
                                    {tosAttempted && !tosAccepted && (
                                        <div style={{ color: "#ff4d4f", fontSize: 12, marginTop: 6, marginLeft: 26 }}>
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gap: 10, marginTop: 20, marginBottom: 8 }}>
                            ...
                            <button
                                ...
                                onMouseEnter={(e) => {
                                    e.currentTarget.style.borderColor = "rgba(62,207,207,0.4)";
                            ...
                            <button
                                ...
                                style={{
                                    ...
                                    color: "var(--dim)", fontSize: 13, fontWeight: 600, cursor: "not-allowed", opacity: 0.5,
                                }}
                            >
                                ...
                                Continue with Apple
                                <span style={{ fontSize: 9, fontWeight: 700, background: "rgba(255,255,255,0.08)", padding: "2px 6px", borderRadius: 8, color: "var(--muted)" }}>SOON</span>
                            </button>
                        </div>
