        ...
        <div className="landing-page">
            ...
            <nav className={`landing-nav ${scrollY > 50 ? "landing-nav--scrolled" : ""}`}>
                ...
                <div className="landing-nav__links">
                    ...
                    <button className="landing-nav__cta" onClick={() => router.push("/_admin/login")}>Get Started</button>
                </div>
            </nav>
            ...
            <section className="hero">
                ...
                <div className="hero__buttons">
                    <button className="btn-hero-primary" onClick={() => router.push("/_admin/login")}>Start Free Trial</button>
                ...
                <div className="pricing-grid">
                    {plans.map((plan, i) => (
                        <div key={i} className={`plan-card ${plan.popular ? "plan-card--popular" : ""}`}>
                            ...
                            <button className={`plan-card__cta ${plan.popular ? "plan-card__cta--primary" : "plan-card__cta--secondary"}`} onClick={() => router.push("/_admin/login")}>
                                {plan.cta}
                            </button>
            ...
            <section className="cta-section">
                ...
                <div className="cta-section__form">
                    ...
                    />
                    <button className="cta-section__submit" onClick={() => router.push("/_admin/login")}>Get Early Access</button>
                </div>
